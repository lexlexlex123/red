...
window.CFG_ANIMATIONS = {
  ...
  available: [
    ...
    { id: 'mirror',       label: 'Зеркало',       category: 'emphasis', enabled: true },
    ...
    { id: 'inkDraw',      label: 'Рисование',     category: 'live',     enabled: true },
    { id: 'camera',       label: 'Камера',        category: 'live',     enabled: true },
    { id: 'particles',    label: 'Частицы',       category: 'live',     enabled: true },
    { id: 'typewriter',   label: 'Смена текста',  category: 'live',     enabled: true },
    { id: 'langFade',     label: 'Перевод',       category: 'live',     enabled: true },
