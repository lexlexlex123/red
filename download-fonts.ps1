...
# fonts-data.js — inline CSS for HTML export (window._FONTS_CSS)
$cssBody = ($faceLines -join "`n")
$cssEscaped = $cssBody.Replace('\', '\\').Replace("'", "\'").Replace("`r", "").Replace("`n", "\n")
$dataJs = @"
// AUTO-GENERATED by download-fonts.ps1 — do not edit by hand.
window._FONTS_CSS = '$cssEscaped';
"@
$dataPath = [System.IO.Path]::Combine($fontsDir, "fonts-data.js")
[System.IO.File]::WriteAllText($dataPath, $dataJs, [System.Text.Encoding]::UTF8)
Write-Host "[OK] fonts\fonts-data.js written (for full HTML export)"

# fonts-list.js
$namesUnique = ($namesList | Select-Object -Unique | Sort-Object)
$namesJsArr = ($namesUnique | ForEach-Object { "  '$_'" }) -join ",`n"
$listJs = @"
...
"@
$listPath = [System.IO.Path]::Combine($fontsDir, "fonts-list.js")
[System.IO.File]::WriteAllText($listPath, $listJs, [System.Text.Encoding]::UTF8)
Write-Host "[OK] fonts\fonts-list.js written"

# React: src/editor/localFonts.js
$reactFontsDir = [System.IO.Path]::Combine($ProjectDir, "src", "editor")
if ([System.IO.Directory]::Exists($reactFontsDir)) {
    $namesEsArr = ($namesUnique | ForEach-Object { "  '$_'," }) -join "`n"
    $localFontsJs = @"
/** AUTO-GENERATED by download-fonts.ps1 - do not edit by hand. */
...
"@
    $localFontsPath = [System.IO.Path]::Combine($reactFontsDir, "localFonts.js")
    $utf8NoBom = New-Object System.Text.UTF8Encoding $false
    [System.IO.File]::WriteAllText($localFontsPath, $localFontsJs, $utf8NoBom)
    Write-Host "[OK] src\editor\localFonts.js written"
}
...
if (-not $env:SLIDES_NO_PAUSE -and $args -notcontains '-NoPause') {
    Read-Host
}
