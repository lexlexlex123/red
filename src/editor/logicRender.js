/**
 * Boolean algebra → IEC logic-gate schematic (ESM port of js/37c-logic.js).
 */
import { isChemFormula, chemThemeColors } from './chemRender.js';
...
export {
  ...
  parseLogic,
  isLogicFormula,
  renderLogicCircuit as logicRender,
  logicThemeColors,
  _prettyLogic as prettyLogic,
};
