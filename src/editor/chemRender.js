/**
 * Chemistry structure diagrams (ESM port of js/37b-chem.js).
 */
  ...
  function _normalizeChemFormula(raw) {
    ...
    s = s.replace(/^\$+|\$+$/g, '');
    s = s.replace(/\\[\[\(]|\\[\]\)]/g, '');
    // \ce{...}, \mathrm{...}, \text{...} (nested once)
    for (let i = 0; i < 6; i++) {
      s = s.replace(/\\(?:ce|mathrm|mathbf|text|textrm|textit|mathsf|bold)\{([^{}]*)\}/g, '$1');
    }
    s = s.replace(/\\left|\\right/g, '');
    s = s.replace(/\\cdot/g, '·').replace(/\\times/g, '·').replace(/\\bullet/g, '·');
    s = s.replace(/_\{([^}]*)\}/g, '$1');
    s = s.replace(/\^\{([^}]*)\}/g, '^$1');
  ...
  function _looksLikeChem(norm) {
    if (!norm || norm.length < 1 || norm.length > 64) return false;
    // Reject obvious math / logic
    if (/[xy=∫∑∏√∞∂]|sin|cos|tan|log|lim|frac|sqrt|infty|partial|land|lor|neg|wedge|vee/i.test(norm)) {
      return false;
    }
    if (!/^[A-Za-z0-9()[\]^+.\-·•*]+$/.test(norm)) return false;
    if (!/[A-Z]/.test(norm)) return false;
    // Must contain at least one element symbol; allow hydrate dots
    let i = 0;
    let atoms = 0;
    while (i < norm.length) {
      const ch = norm[i];
  ...
  const _CHEM_NAMES = {
    ...
    // Extra school / inorganic
    H3PO4: 'фосфорная кислота', H2SiO3: 'кремниевая кислота',
    Na2O: 'оксид натрия', P2O5: 'оксид фосфора(V)', MnO2: 'оксид марганца(IV)',
    Fe2O3: 'оксид железа(III)', Al2O3: 'оксид алюминия', SiO2: 'диоксид кремния',
    CuO: 'оксид меди(II)', ZnO: 'оксид цинка', CaO: 'оксид кальция',
    MgO: 'оксид магния', BaO: 'оксид бария', CrO3: 'оксид хрома(VI)',
    SO3: 'оксид серы(VI)', NO: 'оксид азота(II)', N2O: 'оксид азота(I)',
    N2O5: 'оксид азота(V)', P4O10: 'оксид фосфора(V)',
    Na2SO4: 'сульфат натрия', K2SO4: 'сульфат калия', MgSO4: 'сульфат магния',
    BaSO4: 'сульфат бария', FeSO4: 'сульфат железа(II)', ZnSO4: 'сульфат цинка',
    Al2SO43: 'сульфат алюминия', 'Al2(SO4)3': 'сульфат алюминия',
    Na2CO3: 'карбонат натрия', K2CO3: 'карбонат калия', MgCO3: 'карбонат магния',
    BaCO3: 'карбонат бария', NaHCO3: 'гидрокарбонат натрия',
    'Ca(HCO3)2': 'гидрокарбонат кальция', NH4NO3: 'нитрат аммония',
    KNO3: 'нитрат калия', NaNO3: 'нитрат натрия', 'Ca(NO3)2': 'нитрат кальция',
    'Ba(NO3)2': 'нитрат бария', 'Cu(NO3)2': 'нитрат меди(II)',
    'Pb(NO3)2': 'нитрат свинца(II)', AgNO3: 'нитрат серебра',
    Na3PO4: 'фосфат натрия', 'Ca3(PO4)2': 'фосфат кальция',
    FeCl3: 'хлорид железа(III)', FeCl2: 'хлорид железа(II)',
    CuCl2: 'хлорид меди(II)', AlCl3: 'хлорид алюминия',
    CaCl2: 'хлорид кальция', MgCl2: 'хлорид магция', BaCl2: 'хлорид бария',
    NH4Cl: 'хлорид аммония', AgCl: 'хлорид серебра',
    'Ca(OH)2': 'гидроксид кальция', 'Ba(OH)2': 'гидроксид бария',
    'Mg(OH)2': 'гидроксид магния', 'Al(OH)3': 'гидроксид алюминия',
    'Fe(OH)3': 'гидроксид железа(III)', 'Cu(OH)2': 'гидроксид меди(II)',
    'Zn(OH)2': 'гидроксид цинка', NH4OH: 'гидроксид аммония',
    K2Cr2O7: 'дихромат калия', K2CrO4: 'хромат калия', KMnO4: 'перманганат калия',
    Na2S2O3: 'тиосульфат натрия', NaClO: 'гипохлорит натрия',
    CaC2: 'карбид кальция', SiC: 'карбид кремния', CS2: 'сероуглерод',
    H2O2: 'пероксид водорода', H2S: 'сероводород', HF: 'плавиковая кислота',
    HBr: 'бромоводородная кислота', HI: 'иодоводородная кислота',
    H2SO3: 'сернистая кислота', HNO2: 'азотистая кислота',
    C2H5OH: 'этанол', CH3OH: 'метанол', CH3COOH: 'уксусная кислота',
    HCOOH: 'муравьиная кислота', C6H6: 'бензол', C6H12O6: 'глюкоза',
    C12H22O11: 'сахароза', C3H8: 'пропан', C4H10: 'бутан',
    C2H4: 'этилен', C2H2: 'ацетилен', C2H6: 'этан',
    CH3COCH3: 'ацетон', C6H5OH: 'фенол', C6H5NH2: 'анилин',
    CHCl3: 'хлороформ', CCl4: 'тетрахлорметан', HCN: 'циановодород',
  };
...
export {
  lookupChem,
  isChemFormula,
  _normalizeChemFormula as normalizeChemFormula,
  _prettyFormula as prettyFormula,
  renderChemStructure as chemRender,
  _CHEM_PRESETS as CHEM_PRESETS,
  chemThemeColors,
  formulaKeyToLatex as chemKeyToLatex,
  findChemBySpokenName,
};
