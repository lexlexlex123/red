...
function buildPSlide(container,idx){
  ...
  s.els.forEach(d=>{
    ...
    if(d.type==='text'){
      ...
      c.style.cssText=(csStr?(csStr.endsWith(';')?csStr:csStr+';'):'')+'width:100%;height:100%;overflow:hidden;word-break:break-word;padding:6px 8px;display:flex;flex-direction:column;justify-content:'+jc+';pointer-events:none;user-select:none;';
      ...
      c.innerHTML=d.html||'';el.appendChild(c);
      ...
      el.style.overflow='hidden';el.innerHTML=d.svgContent||'';
